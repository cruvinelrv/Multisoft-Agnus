object dmFn1102: TdmFn1102
  ...
  object qryVendas: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'from P_VENDAS v'
        ...
        '     left outer join p_fatura p1 on (v.nrfatura_venda = p1.codig' +
        'o_fatura)'
      'where v.nrfatura_venda =:NUMERO_FATURA'
      '')
    ...
    object qryVendasDESCRICAO_NAT: TStringField
    ...
    object qryVendasESTADO_CLIENTE: TStringField
      FieldName = 'ESTADO_CLIENTE'
      ProviderFlags = []
      Size = 2
    end
    object qryVendasCONTRIBUINTE_CLIENTE: TStringField
    ...
    object qryVendasCAIXA_CPAGAMENTO: TIntegerField
      FieldName = 'CAIXA_CPAGAMENTO'
      ProviderFlags = []
    end
    object qryVendasEMISSAO_FATURA: TDateField
  ...
  object cdsVendas: TClientDataSet
    ...
    object cdsVendasDESCRICAO_NAT: TStringField
      FieldName = 'DESCRICAO_NAT'
      ProviderFlags = [pfInUpdate]
      Size = 310
    end
    ...
    object cdsVendasESTADO_CLIENTE: TStringField
      FieldName = 'ESTADO_CLIENTE'
      ProviderFlags = []
      Size = 2
    end
    object cdsVendasCONTRIBUINTE_CLIENTE: TStringField
      FieldName = 'CONTRIBUINTE_CLIENTE'
      ProviderFlags = []
      Size = 1
    end
    ...
    object cdsVendasCAIXA_CPAGAMENTO: TIntegerField
      FieldName = 'CAIXA_CPAGAMENTO'
      ProviderFlags = []
    end
    object cdsVendasEMISSAO_FATURA: TDateField
      FieldName = 'EMISSAO_FATURA'
      ProviderFlags = []
    end
  end
  object cdsGrid: TClientDataSet
    ...
    Top = 72
    Data = {
      
      01004900000001000557494454480200020014000000}
    object cdsGridCODIGO_VENDA: TIntegerField
      FieldName = 'CODIGO_VENDA'
    end
    object cdsGridSERIE: TStringField
      FieldName = 'SERIE'
    end
    object cdsGridNUM_NOTAFISCAL: TIntegerField
      FieldName = 'NUM_NOTAFISCAL'
    end
    ...
    object cdsGridTIPO_PAGAM: TIntegerField
  ...
  object cdsItemVenda_Temp: TClientDataSet
    ...
    Top = 171
    Data = {
      120100009619E0BD01000000180000000A000000000003000000120109434F44
      ...
      4E544944414445080004000000010007535542545950450200490006004D6F6E
      65790008444553434F4E544F08000400000000000000}
    ...
    object cdsItemVenda_TempQUANTIDADE: TCurrencyField
      FieldName = 'QUANTIDADE'
    end
  ...
  object qryReceber2: TSQLQuery
    ...
    SQL.Strings = (
        ...
        '_receber'
      'from P_RECEBER r'
      'where substring(r.duplicata_receber from 1 for 8) =:DUPLICATA')
    SQLConnection = DmPrincipal.DbConexao
    Left = 297
    Top = 444
