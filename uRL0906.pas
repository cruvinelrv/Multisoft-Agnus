...
begin
   ...
   begin
      ...
      begin
         ...
         ppSubReport1.Visible := True; // analítico
         ppSubReport3.Visible := True; // Sintético
...
begin
   if edtEspecifico.Text = '' then
      Text := 'Movimento - Conta Contábil ' + edtDataIni.Text + ' a ' + edtDataFim.Text + ' Todos'
   else
      Text := 'Movimento - Conta Contábil ' + edtDataIni.Text + ' a ' + edtDataFim.Text + ' Específico';
end;
