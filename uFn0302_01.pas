...
begin
   ...
   begin
      if Application.MessageBox('Deseja que a data da liquidação seja anterior' + #13 + ' a data do vencimento?', 'Confirmação', MB_YESNO+MB_ICONQUESTION) = mrYes then
...
begin
   ...
   begin
      ...
      Application.MessageBox('Cheque baixado com sucesso', 'Informação', MB_OK+MB_ICONEXCLAMATION);
   end;
