object dmGr03: TdmGr03
  ...
  object qryProdutos: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT * FROM P_PRODUTOS'
      'WHERE COD_EMPRESA=:EMPRESA'
      '  AND CLASSE_PRODUTO=:CLASSE'
      '  AND (GRUPO_PRODUTO>=:GRU1'
      '  AND GRUPO_PRODUTO<=:GRU2)'
  ...
  object qryBalanco: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT * FROM P_BALANCO WHERE COD_EMPRESA=:EMPRESA')
    SQLConnection = DmPrincipal.DbConexao
    Left = 44
    Top = 136
    object qryBalancoDATA_BALANCO: TDateField
      FieldName = 'DATA_BALANCO'
      Required = True
    end
    object qryBalancoPRODUTO_BALANCO: TIntegerField
      FieldName = 'PRODUTO_BALANCO'
      Required = True
    end
    object qryBalancoESTOQUE_BALANCO: TFMTBCDField
      FieldName = 'ESTOQUE_BALANCO'
      Precision = 15
    end
    object qryBalancoVALIDADE_BALANCO: TDateField
      FieldName = 'VALIDADE_BALANCO'
    end
    object qryBalancoPCOMPRA_BALANCO: TFMTBCDField
      FieldName = 'PCOMPRA_BALANCO'
      Precision = 15
    end
    object qryBalancoPCUSTO_BALANCO: TFMTBCDField
      FieldName = 'PCUSTO_BALANCO'
      Precision = 15
    end
    object qryBalancoUSUARIO_BALANCO: TStringField
      FieldName = 'USUARIO_BALANCO'
    end
    object qryBalancoCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
  end
  ...
  object cdsBalanco: TClientDataSet
    ...
    Left = 228
    Top = 136
    object cdsBalancoDATA_BALANCO: TDateField
      FieldName = 'DATA_BALANCO'
      Required = True
    end
    object cdsBalancoPRODUTO_BALANCO: TIntegerField
      FieldName = 'PRODUTO_BALANCO'
      Required = True
    end
    object cdsBalancoESTOQUE_BALANCO: TFMTBCDField
      FieldName = 'ESTOQUE_BALANCO'
      Precision = 15
    end
    object cdsBalancoVALIDADE_BALANCO: TDateField
      FieldName = 'VALIDADE_BALANCO'
    end
    object cdsBalancoPCOMPRA_BALANCO: TFMTBCDField
      FieldName = 'PCOMPRA_BALANCO'
      Precision = 15
    end
    object cdsBalancoPCUSTO_BALANCO: TFMTBCDField
      FieldName = 'PCUSTO_BALANCO'
      Precision = 15
    end
    object cdsBalancoUSUARIO_BALANCO: TStringField
      FieldName = 'USUARIO_BALANCO'
    end
    object cdsBalancoCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
  end
