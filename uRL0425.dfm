object frmRL0425: TfrmRL0425
  Left = 314
  Top = 173
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio de NF/CF Simples'
  ClientHeight = 300
  ClientWidth = 437
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtCodigoVendedor: TJvValidateEdit
      Left = 80
      Top = 72
      Width = 57
      Height = 21
    ...
    object edtCodigoCliente: TJvValidateEdit
      Left = 80
      Top = 104
      Width = 57
      Height = 21
    ...
    object edtCodigoProduto: TJvValidateEdit
      Left = 80
      Top = 136
      Width = 57
      Height = 21
  ...
  object rptRelatorio: TppReport
    ...
    Version = '10.02'
    mmColumnWidth = 0
    DataPipelineName = 'dbpDoc_Simples'
    ...
    object ppDetailBand2: TppDetailBand
      ...
      object ppSubReport1: TppSubReport
        ...
        Visible = False
        DataPipelineName = 'dbpItens_Doc_Simples'
        mmHeight = 5027
        mmLeft = 0
        mmTop = 529
        mmWidth = 197300
        ...
        object ppChildReport1: TppChildReport
          AutoStop = False
          DataPipeline = dbpItens_Doc_Simples
          PrinterSetup.BinName = 'Default'
          PrinterSetup.DocumentName = 'Report'
          PrinterSetup.PaperName = 'A4'
          PrinterSetup.PrinterName = 'Default'
  ...
  object dbpDoc_Simples: TppDBPipeline
    DataSource = dmRL0425.dtsDoc_Simples
    UserName = 'dbpDoc_Simples'
    Left = 288
    Top = 192
  end
  object dbpItens_Doc_Simples: TppDBPipeline
    DataSource = dmRL0425.dstItens_Doc_Simples
    UserName = 'dbpItens_Doc_Simples'
    Left = 288
    Top = 224
  end
end
