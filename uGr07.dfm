object frmGr07: TfrmGr07
  ...
  object dsFornecedor: TDataSource
    DataSet = dmGr07.qryPesqFornecedor
    Left = 368
    Top = 96
  end
  object dsProdutos: TDataSource
    DataSet = dmGr07.qryProdutos
    Left = 368
    Top = 6
  end
  object dsPedido: TDataSource
    AutoEdit = False
    DataSet = dmGr07.cdsPedidoCompra
    OnDataChange = dsPedidoDataChange
    Left = 368
    Top = 36
  end
  object dsClientes: TDataSource
    DataSet = dmGr07.qryCliente
    Left = 368
    Top = 66
  end
end
