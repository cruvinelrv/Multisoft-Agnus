object dmRL0404: TdmRL0404
  ...
  object qryVendas: TSQLQuery
    ...
    Params = <>
    SQL.Strings = (
      'select v. *, i.quantidade_ivendas, c.descricao_cpagamento,'
      ...
      'else '#39'N'#195'O CADASTRADO'#39
      'end as DESCRICAO_GRUPO'
      'from P_VENDAS v'
      
        'left outer join p_vendas_itens i on (v.codigo_venda = i.codigo_i' +
        'venda)'
      
        'left outer join p_cpagamento c on (v.cpagamento_venda = c.codigo' +
        '_cpagamento)'
  ...
  object cdsVendas: TClientDataSet
    ...
    object cdsVendasQUANTIDADE_IVENDAS: TFMTBCDField
    ...
    object cdsVendasDESCONTO_IVENDAS: TFMTBCDField
      FieldName = 'DESCONTO_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsVendasGRUPO_PRODUTO: TIntegerField
      FieldName = 'GRUPO_PRODUTO'
    end
    object cdsVendasTOTAL_IVENDA: TFMTBCDField
    ...
    object cdsVendasDESCRICAO_GRUPO: TStringField
  ...
  object ppVendas: TppDBPipeline
    ...
    object ppVendasppField121: TppField
    ...
    object ppVendasppField122: TppField
