object dmRL0333: TdmRL0333
  ...
  object cdsProdutos: TClientDataSet
    ...
    object cdsProdutosCODIGO_GRUPO: TIntegerField
    ...
    object cdsProdutosCOMISSAO_GRUPO: TFMTBCDField
      FieldName = 'COMISSAO_GRUPO'
      Precision = 15
      Size = 2
    end
    object cdsProdutosCOMISSAO1_GRUPO: TFMTBCDField
      FieldName = 'COMISSAO1_GRUPO'
      Precision = 15
      Size = 2
    end
    object cdsProdutosFATOR_VEND_GRUPO: TFMTBCDField
    ...
    object cdsProdutosSUSPENSO_GRUPO: TStringField
      FieldName = 'SUSPENSO_GRUPO'
      FixedChar = True
      Size = 1
    end
    object cdsProdutosTRANSFERE_GRUPO: TFMTBCDField
      FieldName = 'TRANSFERE_GRUPO'
      Precision = 15
      Size = 2
    end
    object cdsProdutosOBSERVACAO_GRUPO: TStringField
      FieldName = 'OBSERVACAO_GRUPO'
    end
    object cdsProdutosNEGATIVO_GRUPO: TStringField
      FieldName = 'NEGATIVO_GRUPO'
      FixedChar = True
      Size = 1
    end
    object cdsProdutosCOD_EMPRESA_1: TIntegerField
      FieldName = 'COD_EMPRESA_1'
    end
    object cdsProdutosCODIGO_SECAO: TIntegerField
      FieldName = 'CODIGO_SECAO'
    end
    object cdsProdutosDESCRICAO_SECAO: TStringField
      FieldName = 'DESCRICAO_SECAO'
    end
    object cdsProdutosCOD_EMPRESA_2: TIntegerField
      FieldName = 'COD_EMPRESA_2'
    end
  end
