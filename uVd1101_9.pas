...
begin
   ...
   begin
      Application.MessageBox('Escolha o CST.','Atenção', MB_OK + MB_ICONASTERISK);
      cbxCST.SetFocus;
      exit;
   end;
   ...
   if (Copy(cbxCST.Text,1,3) = '000') or (Copy(cbxCST.Text,1,3) = '020') then
      ...
      begin
         Application.MessageBox('A alíquota deve ser maior que zero!','Atenção', MB_OK + MB_ICONASTERISK);
   ...
   begin
      Application.MessageBox('A quantidade deve ser maior que zero!','Atenção', MB_OK + MB_ICONASTERISK);
      edtQtd.SetFocus;
      exit;
   end;
   ...
   begin
      Application.MessageBox('O valor deve ser maior que zero!','Atenção', MB_OK + MB_ICONASTERISK);
   ...
   begin
      Application.MessageBox('O código deve ser digitado','Atenção', MB_OK + MB_ICONASTERISK);
      edtCodigo.SetFocus;
      exit;
   end;
