object dmRL0418: TdmRL0418
  ...
  object qryVenda: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'osaida_venda, p.fornecedor_pedido,'
      
        'r.codigo_produto, r.descricao_produto, i.quantidade_ivendas, i.d' +
        'esconto_ivendas, i.valorbruto_ivendas,'
      
        'c.endereco_cliente, c1.descricao_cidade, c1.uf_cidade, r.observa' +
        'cao_produto,'
      '(i.valorbruto_ivendas - i.desconto_ivendas) as "Valor_Recebido",'
      
        '((i.desconto_ivendas / i.valorbruto_ivendas) * 100) as "Percent_' +
        'Desc",'
      '(i.valorbruto_ivendas * i.quantidade_ivendas) as "Total",'
      ...
      'from P_VENDAS v'
        ...
        'o_produto)'
      'where v.data_venda >=:DATA1'
      'and v.data_venda <=:DATA2'
      'and v.cliente_venda >=:CLIENTE1'
      'and v.cliente_venda <=:CLIENTE2'
      'and v.vendedor_venda >=:VENDEDOR1'
      'and v.vendedor_venda <=:VENDEDOR2'
      'and p.fornecedor_pedido >=:FORNECEDOR1'
      'and p.fornecedor_pedido <=:FORNECEDOR2'
    ...
    object qryVendaFORNECEDOR_PEDIDO: TIntegerField
      FieldName = 'FORNECEDOR_PEDIDO'
    end
    object qryVendaCODIGO_PRODUTO: TIntegerField
    ...
    object qryVendaQUANTIDADE_IVENDAS: TFMTBCDField
      FieldName = 'QUANTIDADE_IVENDAS'
      Precision = 15
      Size = 3
    end
    object qryVendaDESCONTO_IVENDAS: TFMTBCDField
      FieldName = 'DESCONTO_IVENDAS'
      Precision = 15
      Size = 2
    end
    object qryVendaVALORBRUTO_IVENDAS: TFMTBCDField
      FieldName = 'VALORBRUTO_IVENDAS'
      Precision = 15
      Size = 4
    end
    object qryVendaValor_Recebido: TFMTBCDField
      FieldName = 'Valor_Recebido'
      Precision = 15
      Size = 4
    end
    object qryVendaPercent_Desc: TFMTBCDField
    ...
    object qryVendaDESCRICAO_CIDADE: TStringField
      FieldName = 'DESCRICAO_CIDADE'
      Size = 30
    end
    object qryVendaUF_CIDADE: TStringField
      FieldName = 'UF_CIDADE'
      FixedChar = True
      Size = 2
    end
    object qryVendaOBSERVACAO_PRODUTO: TMemoField
  ...
  object qryVendas_Itens: TSQLQuery
    ...
    SQL.Strings = (
      ...
      'and i.produto_ivenda >=:PRODUTO1'
      'and i.produto_ivenda <=:PRODUTO2')
    SQLConnection = DmPrincipal.DbConexao
    Left = 38
    Top = 123
  ...
  object cdsVenda: TClientDataSet
    ...
    object cdsVendaFORNECEDOR_PEDIDO: TIntegerField
      FieldName = 'FORNECEDOR_PEDIDO'
    end
    object cdsVendaCODIGO_PRODUTO: TIntegerField
      FieldName = 'CODIGO_PRODUTO'
    end
    object cdsVendaDESCRICAO_PRODUTO: TStringField
      FieldName = 'DESCRICAO_PRODUTO'
      FixedChar = True
      Size = 40
    end
    object cdsVendaQUANTIDADE_IVENDAS: TFMTBCDField
      FieldName = 'QUANTIDADE_IVENDAS'
      Precision = 15
      Size = 3
    end
    object cdsVendaDESCONTO_IVENDAS: TFMTBCDField
      FieldName = 'DESCONTO_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsVendaVALORBRUTO_IVENDAS: TFMTBCDField
      FieldName = 'VALORBRUTO_IVENDAS'
      Precision = 15
      Size = 4
    end
    ...
    object cdsVendaPercent_Desc: TFMTBCDField
      FieldName = 'Percent_Desc'
      Precision = 15
      Size = 6
    end
    ...
    object cdsVendaENDERECO_CLIENTE: TStringField
      FieldName = 'ENDERECO_CLIENTE'
      Size = 40
    end
    object cdsVendaDESCRICAO_CIDADE: TStringField
      FieldName = 'DESCRICAO_CIDADE'
      Size = 30
    end
    object cdsVendaUF_CIDADE: TStringField
      FieldName = 'UF_CIDADE'
      FixedChar = True
      Size = 2
    end
    object cdsVendaOBSERVACAO_PRODUTO: TMemoField
      FieldName = 'OBSERVACAO_PRODUTO'
      BlobType = ftMemo
      Size = 1
    end
  ...
  object ppDBVendas: TppDBPipeline
    ...
    object ppDBVendasppField38: TppField
      Alignment = taRightJustify
      FieldAlias = 'FORNECEDOR_PEDIDO'
      FieldName = 'FORNECEDOR_PEDIDO'
      FieldLength = 0
    ...
    object ppDBVendasppField39: TppField
      Alignment = taRightJustify
      FieldAlias = 'CODIGO_PRODUTO'
      FieldName = 'CODIGO_PRODUTO'
      FieldLength = 0
    ...
    object ppDBVendasppField40: TppField
      FieldAlias = 'DESCRICAO_PRODUTO'
      FieldName = 'DESCRICAO_PRODUTO'
      FieldLength = 40
      DisplayWidth = 40
    ...
    object ppDBVendasppField41: TppField
      Alignment = taRightJustify
      FieldAlias = 'QUANTIDADE_IVENDAS'
      FieldName = 'QUANTIDADE_IVENDAS'
      FieldLength = 3
    ...
    object ppDBVendasppField42: TppField
      Alignment = taRightJustify
    ...
    object ppDBVendasppField43: TppField
      Alignment = taRightJustify
      FieldAlias = 'VALORBRUTO_IVENDAS'
      FieldName = 'VALORBRUTO_IVENDAS'
      FieldLength = 4
    ...
    object ppDBVendasppField44: TppField
      Alignment = taRightJustify
    ...
    object ppDBVendasppField45: TppField
      Alignment = taRightJustify
    ...
    object ppDBVendasppField46: TppField
      Alignment = taRightJustify
      FieldAlias = 'Total'
      FieldName = 'Total'
      FieldLength = 7
    ...
    object ppDBVendasppField47: TppField
    ...
    object ppDBVendasppField48: TppField
    ...
    object ppDBVendasppField49: TppField
    ...
    object ppDBVendasppField50: TppField
