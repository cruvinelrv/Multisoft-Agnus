object dmGr06: TdmGr06
  ...
  object qryPedidoCompraItem: TSQLQuery
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftString
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM  P_PEDIDO_ITEM WHERE CODIGO_PEDIDO=:PEDIDO AND COD' +
        '_EMPRESA=:EMPRESA')
    SQLConnection = DmPrincipal.DbConexao
    Left = 42
    Top = 226
    object qryPedidoCompraItemCODIGO_PEDIDO: TIntegerField
      FieldName = 'CODIGO_PEDIDO'
    end
    object qryPedidoCompraItemPRODUTO_PEDIDO: TIntegerField
      FieldName = 'PRODUTO_PEDIDO'
    end
    object qryPedidoCompraItemDESCRICAO_PEDIDO: TStringField
      FieldName = 'DESCRICAO_PEDIDO'
      Size = 50
    end
    object qryPedidoCompraItemQUANTIDADE_PEDIDO: TFMTBCDField
      FieldName = 'QUANTIDADE_PEDIDO'
      Precision = 15
      Size = 3
    end
    object qryPedidoCompraItemPRECO_PEDIDO: TFMTBCDField
      FieldName = 'PRECO_PEDIDO'
      Precision = 15
    end
    object qryPedidoCompraItemFABRICA_PEDIDO: TStringField
      FieldName = 'FABRICA_PEDIDO'
      FixedChar = True
      Size = 15
    end
    object qryPedidoCompraItemCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
  end
  object dspPedidoCompraItem: TDataSetProvider
    DataSet = qryPedidoCompraItem
    Left = 160
    Top = 226
  end
  object cdsPedidoCompraItem: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftString
    ...
    ProviderName = 'dspPedidoCompraItem'
    Left = 277
    Top = 226
    object cdsPedidoCompraItemCODIGO_PEDIDO: TIntegerField
      FieldName = 'CODIGO_PEDIDO'
    end
    object cdsPedidoCompraItemPRODUTO_PEDIDO: TIntegerField
      FieldName = 'PRODUTO_PEDIDO'
    end
    object cdsPedidoCompraItemDESCRICAO_PEDIDO: TStringField
      FieldName = 'DESCRICAO_PEDIDO'
      Size = 50
    end
    object cdsPedidoCompraItemQUANTIDADE_PEDIDO: TFMTBCDField
      FieldName = 'QUANTIDADE_PEDIDO'
      Precision = 15
      Size = 3
    end
    object cdsPedidoCompraItemPRECO_PEDIDO: TFMTBCDField
      FieldName = 'PRECO_PEDIDO'
      Precision = 15
    end
    object cdsPedidoCompraItemFABRICA_PEDIDO: TStringField
      FieldName = 'FABRICA_PEDIDO'
      FixedChar = True
      Size = 15
    end
    object cdsPedidoCompraItemCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
  end
  ...
  object qryProdutos: TSQLQuery
    ...
    SQL.Strings = (
      'SELECT * FROM P_PRODUTOS WHERE CLASSE_PRODUTO=1'
      
        ' AND COD_EMPRESA=:EMPRESA AND CODIGO_PRODUTO=:PRODUTO ORDER BY D' +
        'ESCRICAO_PRODUTO'
      '')
    SQLConnection = DmPrincipal.DbConexao
    Left = 55
  ...
  object qryPesqFornecedor: TSQLQuery
    ...
    SQL.Strings = (
      ...
      ' FROM E_CLIENTE'
      'where E_CLIENTE.CODIGO_CLIENTE =:fornecedor AND tipo_cliente=2')
    SQLConnection = DmPrincipal.DbConexao
    Left = 56
    Top = 8
