...
uses
  SysUtils, Classes, FMTBcd, ppDB, DB, ppComm, ppRelatv, ppDBPipe,
  DBClient, Provider, SqlExpr;

type
  TdmRL0403 = class(TDataModule)
    qryVendas: TSQLQuery;
    ...
    cdsVendasDESCRI_PAGAM: TStringField;
    cdsVendasTOTAL: TFMTBCDField;
    cdsVendasNOME_VENDEDOR: TStringField;
    cdsVendasVENDA_COMISS: TFMTBCDField;
    cdsVendasPAGAM_COMISS: TFMTBCDField;
    cdsVendasPERC_COMISSAO_CPAGAMENTO: TFMTBCDField;
