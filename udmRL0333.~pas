...
type
  TdmRL0333 = class(TDataModule)
    ...
    cdsProdutosCODIGO_GRUPO: TIntegerField;
    cdsProdutosDESCRICAO_GRUPO: TStringField;
    cdsProdutosCOMISSAO_GRUPO: TFMTBCDField;
    cdsProdutosCOMISSAO1_GRUPO: TFMTBCDField;
    cdsProdutosFATOR_VEND_GRUPO: TFMTBCDField;
    cdsProdutosCODIGO_SECAO_GRUPO: TIntegerField;
    cdsProdutosSUSPENSO_GRUPO: TStringField;
    cdsProdutosTRANSFERE_GRUPO: TFMTBCDField;
    cdsProdutosOBSERVACAO_GRUPO: TStringField;
    cdsProdutosNEGATIVO_GRUPO: TStringField;
    cdsProdutosCOD_EMPRESA_1: TIntegerField;
    cdsProdutosCODIGO_SECAO: TIntegerField;
    cdsProdutosDESCRICAO_SECAO: TStringField;
    cdsProdutosCOD_EMPRESA_2: TIntegerField;
