...
begin
   ...
   begin
      ...
      begin
         ...
         begin
            Application.MessageBox('Data da Venda fora do período informado', 'Informação', MB_OK+MB_ICONEXCLAMATION);
            edtVenda.SetFocus;
            Exit;
         end;
      end;
...
begin
   Text := 'Produtos Vendidos no Período de ' + edtDataIni.Text + ' à ' + edtDataFim.Text;
end;
