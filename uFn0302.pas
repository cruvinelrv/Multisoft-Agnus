...
begin
   ...
   dmFn0302.cdsGrid.Params.ParamByName('CAMPO_BUSCA').AsString := 'A'; // apenas os cheques que não foram baixados
...
begin
   if not Verifica_acesso(228) then // permissão para baixar cheque
      Exit;
