object frmRL0330: TfrmRL0330
  Left = 242
  Top = 128
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Listagem de Produtos com Estoque'
  ClientHeight = 424
  ClientWidth = 467
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object rgpSeparador: TRadioGroup
      Left = 24
      Top = 184
      Width = 421
      Height = 40
    ...
    object edtSecao: TJvValidateEdit
      ...
      TabOrder = 0
      OnKeyDown = edtSecaoKeyDown
    end
    object edtGrupoIni: TJvValidateEdit
      Left = 91
      Top = 36
      Width = 85
      Height = 21
      ...
      CriticalPoints.MinValueIncluded = False
      TabOrder = 1
      OnKeyDown = edtGrupoIniKeyDown
    end
    object edtGrupoFim: TJvValidateEdit
      Left = 91
      Top = 59
      Width = 85
      Height = 21
      ...
      CriticalPoints.MinValueIncluded = False
      TabOrder = 2
      OnKeyDown = edtGrupoFimKeyDown
    end
    object edtCST: TJvValidateEdit
      Left = 72
      Top = 231
      Width = 121
      Height = 21
    ...
    object edtFabricante: TJvValidateEdit
      ...
      CriticalPoints.MinValueIncluded = False
      TabOrder = 3
      OnKeyDown = edtFabricanteKeyDown
    end
    object Edit1: TEdit
      Left = 200
      Top = 14
    ...
    object cbxGrade: TCheckBox
      Left = 24
      Top = 260
      Width = 97
      Height = 17
      Caption = 'Imprime Grade'
      TabOrder = 9
    end
    object cbxZerados: TCheckBox
      Left = 24
      Top = 284
      Width = 97
      Height = 17
      Caption = 'Imprime Zerados'
      TabOrder = 10
    end
    object cbxVenda: TCheckBox
      Left = 24
      Top = 308
      Width = 129
      Height = 17
      Caption = 'Imprime Pre'#231'o Venda'
      TabOrder = 11
    end
    object cbxCusto: TCheckBox
      Left = 24
      Top = 332
      Width = 120
      Height = 17
      Caption = 'Imprime Pre'#231'o Custo'
      TabOrder = 12
    end
    object cbxCompra: TCheckBox
      Left = 24
      Top = 356
      Width = 129
      Height = 17
      Caption = 'Imprime Pre'#231'o Compra'
      TabOrder = 13
    end
    object rgpModelo: TRadioGroup
      Left = 24
      Top = 145
      Width = 421
      Height = 40
      ...
      ParentFont = False
      TabOrder = 5
      OnClick = rgpModeloClick
    end
  end
  object ppReportFabricante: TppReport
    AutoStop = False
    DataPipeline = dmRL0330.ppDBConsulta
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel20: TppLabel
        ...
        Border.Visible = False
        Border.Weight = 1.000000000000000000
        Caption = 'Listagem de Produtos Apenas com Estoque'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
    ...
    object ppDetailBand1: TppDetailBand
      ...
      object ppSubReportGradeF: TppSubReport
        UserName = 'SubReportGradeF'
        ExpandAll = False
        NewPrintJob = False
        OutlineSettings.CreateNode = True
        TraverseAllData = False
        DataPipelineName = 'ppDBGrade'
        mmHeight = 3703
        mmLeft = 0
        mmTop = 4498
        mmWidth = 197300
        ...
        object ppChildReport1: TppChildReport
          AutoStop = False
          DataPipeline = dmRL0330.ppDBGrade
          PrinterSetup.BinName = 'Default'
          PrinterSetup.DocumentName = 'Report'
          PrinterSetup.PaperName = 'A4'
          PrinterSetup.PrinterName = 'Default'
    ...
    object ppSummaryBand2: TppSummaryBand
      ...
      object ppLabel35: TppLabel
        ...
        Border.Visible = False
        Border.Weight = 1.000000000000000000
        Caption = 'Total Geral (Estoque x Preco) ='
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Name = 'Draft 20cpi'
        Font.Size = 8
  ...
  object ppReportGrupo: TppReport
    AutoStop = False
    DataPipeline = dmRL0330.ppDBConsulta
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    ...
    object ppDetailBand9: TppDetailBand
      ...
      object ppSubReportGrade: TppSubReport
        UserName = 'SubReportGrade'
        ExpandAll = False
        NewPrintJob = False
        OutlineSettings.CreateNode = True
        TraverseAllData = False
  ...
  object ppReportNenhum: TppReport
    AutoStop = False
    DataPipeline = dmRL0330.ppDBConsulta
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
    ...
    object ppDetailBand2: TppDetailBand
      ...
      object ppSubReportGrade2: TppSubReport
        UserName = 'SubReportGrade2'
        ExpandAll = False
        KeepTogether = True
        NewPrintJob = False
        OutlineSettings.CreateNode = True
  ...
  object ppReportGrupoM2: TppReport
    AutoStop = False
    DataPipeline = dmRL0330.ppDBConsulta
    PrinterSetup.BinName = 'Default'
    PrinterSetup.DocumentName = 'Report'
