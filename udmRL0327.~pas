...
type
  TdmRL0327 = class(TDataModule)
    ...
    cdsProdutosDESCRICAO_SUBGRUPO: TStringField;
    cdsProdutosNOME_FABRICANTE: TStringField;
    cdsProdutosTOTAL_PRE_VEN: TFMTBCDField;
    cdsProdutosTOTAL_PRE_CUS: TFMTBCDField;
    cdsProdutosTOTAL_PRE_COM: TFMTBCDField;
    cdsProdutosPRATELEIRA: TStringField;
    dtsProdutos: TDataSource;
    cdsTipoVenda: TClientDataSet;
    dtsTipoVenda: TDataSource;
    cdsTipoVendaTIPO_PRECO_VENDA: TStringField;
    cdsTipoVendaCODIGO: TIntegerField;
    cdsTipoVendaPER_AUMENTO: TFloatField;
    ppTipoVenda: TppDBPipeline;
    cdsProdutosDESCRICAO_SITUACAO: TStringField;
