object dmRL0401: TdmRL0401
  ...
  object cdsVenda: TClientDataSet
    ...
    object cdsVendaVALOR_RECEBIDO: TFMTBCDField
      FieldName = 'VALOR_RECEBIDO'
      Precision = 15
      Size = 2
    end
    object cdsVendaENT_PERIODO: TFMTBCDField
      FieldName = 'ENT_PERIODO'
      Precision = 15
      Size = 2
    end
    object cdsVendaVALOR_VENDA: TFMTBCDField
      FieldName = 'VALOR_VENDA'
      Precision = 15
      Size = 2
    end
    object cdsVendaDATA_CAIXA: TStringField
  ...
  object qryI_Venda: TSQLQuery
    ...
    SQL.Strings = (
      'select * from P_VENDAS_ITENS where CODIGO_IVENDA =:CODIGO_IVENDA')
    SQLConnection = DmPrincipal.DbConexao
    Left = 24
    Top = 75
    object qryI_VendaID_VENDA_ITEM: TIntegerField
      FieldName = 'ID_VENDA_ITEM'
    end
    object qryI_VendaCODIGO_IVENDA: TIntegerField
      FieldName = 'CODIGO_IVENDA'
      Required = True
    end
    object qryI_VendaPRODUTO_IVENDA: TIntegerField
      FieldName = 'PRODUTO_IVENDA'
      Required = True
    end
    object qryI_VendaDESCRICAO_IVENDAS: TStringField
      FieldName = 'DESCRICAO_IVENDAS'
      Size = 80
    end
    object qryI_VendaVALORBRUTO_IVENDAS: TFMTBCDField
      FieldName = 'VALORBRUTO_IVENDAS'
      Precision = 15
      Size = 4
    end
    object qryI_VendaQUANTIDADE_IVENDAS: TFMTBCDField
      FieldName = 'QUANTIDADE_IVENDAS'
      Required = True
      Precision = 15
      Size = 3
    end
    object qryI_VendaGRADE_IVENDAS: TStringField
      FieldName = 'GRADE_IVENDAS'
      Size = 5
    end
    object qryI_VendaPROMOCAO_IVENDAS: TStringField
      FieldName = 'PROMOCAO_IVENDAS'
      Size = 1
    end
    object qryI_VendaFABRICA_IVENDAS: TStringField
      FieldName = 'FABRICA_IVENDAS'
      Size = 15
    end
    object qryI_VendaSERIE_IVENDAS: TStringField
      FieldName = 'SERIE_IVENDAS'
      Size = 60
    end
    object qryI_VendaDESCONTO_IVENDAS: TFMTBCDField
      FieldName = 'DESCONTO_IVENDAS'
      Precision = 15
      Size = 2
    end
    object qryI_VendaICM_IVENDAS: TFMTBCDField
      FieldName = 'ICM_IVENDAS'
      Precision = 15
      Size = 2
    end
    object qryI_VendaIPI_IVENDAS: TFMTBCDField
      FieldName = 'IPI_IVENDAS'
      Precision = 15
      Size = 2
    end
    object qryI_VendaREDUTOR_IVENDAS: TFMTBCDField
      FieldName = 'REDUTOR_IVENDAS'
      Precision = 15
      Size = 4
    end
    object qryI_VendaTRIBUTACAO_IVENDAS: TStringField
      FieldName = 'TRIBUTACAO_IVENDAS'
      Size = 3
    end
    object qryI_VendaFISCAL_IVENDAS: TStringField
      FieldName = 'FISCAL_IVENDAS'
      Size = 5
    end
    object qryI_VendaGARANTIA_IVENDAS: TStringField
      FieldName = 'GARANTIA_IVENDAS'
      Size = 10
    end
    object qryI_VendaTECNICO_IVENDAS: TIntegerField
      FieldName = 'TECNICO_IVENDAS'
    end
    object qryI_VendaALTURA_IVENDAS: TFMTBCDField
      FieldName = 'ALTURA_IVENDAS'
      Precision = 15
      Size = 2
    end
    object qryI_VendaLARGURA_IVENDAS: TFMTBCDField
      FieldName = 'LARGURA_IVENDAS'
      Precision = 15
      Size = 2
    end
    object qryI_VendaCOMPRIMENTO_VENDAS: TFMTBCDField
      FieldName = 'COMPRIMENTO_VENDAS'
      Precision = 15
      Size = 2
    end
    object qryI_VendaQTDE_VENDAS: TIntegerField
      FieldName = 'QTDE_VENDAS'
    end
    object qryI_VendaCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 40
    end
    object qryI_VendaCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
    object qryI_VendaCLASSE_IVENDA: TStringField
      FieldName = 'CLASSE_IVENDA'
      Size = 1
    end
    object qryI_VendaCFOP: TStringField
      FieldName = 'CFOP'
      Size = 5
    end
    object qryI_VendaSERIE_VENDA: TStringField
      FieldName = 'SERIE_VENDA'
      Size = 2
    end
  end
  object dspI_Venda: TDataSetProvider
    DataSet = qryI_Venda
    Options = [poAllowCommandText]
    Left = 96
    Top = 75
  end
  object cdsI_Venda: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'dspI_Venda'
    Left = 176
    Top = 75
    object cdsI_VendaID_VENDA_ITEM: TIntegerField
      FieldName = 'ID_VENDA_ITEM'
    end
    object cdsI_VendaCODIGO_IVENDA: TIntegerField
      FieldName = 'CODIGO_IVENDA'
      Required = True
    end
    object cdsI_VendaPRODUTO_IVENDA: TIntegerField
      FieldName = 'PRODUTO_IVENDA'
      Required = True
    end
    object cdsI_VendaDESCRICAO_IVENDAS: TStringField
      FieldName = 'DESCRICAO_IVENDAS'
      Size = 80
    end
    object cdsI_VendaVALORBRUTO_IVENDAS: TFMTBCDField
      FieldName = 'VALORBRUTO_IVENDAS'
      Precision = 15
      Size = 4
    end
    object cdsI_VendaQUANTIDADE_IVENDAS: TFMTBCDField
      FieldName = 'QUANTIDADE_IVENDAS'
      Required = True
      Precision = 15
      Size = 3
    end
    object cdsI_VendaGRADE_IVENDAS: TStringField
      FieldName = 'GRADE_IVENDAS'
      Size = 5
    end
    object cdsI_VendaPROMOCAO_IVENDAS: TStringField
      FieldName = 'PROMOCAO_IVENDAS'
      Size = 1
    end
    object cdsI_VendaFABRICA_IVENDAS: TStringField
      FieldName = 'FABRICA_IVENDAS'
      Size = 15
    end
    object cdsI_VendaSERIE_IVENDAS: TStringField
      FieldName = 'SERIE_IVENDAS'
      Size = 60
    end
    object cdsI_VendaDESCONTO_IVENDAS: TFMTBCDField
      FieldName = 'DESCONTO_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsI_VendaICM_IVENDAS: TFMTBCDField
      FieldName = 'ICM_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsI_VendaIPI_IVENDAS: TFMTBCDField
      FieldName = 'IPI_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsI_VendaREDUTOR_IVENDAS: TFMTBCDField
      FieldName = 'REDUTOR_IVENDAS'
      Precision = 15
      Size = 4
    end
    object cdsI_VendaTRIBUTACAO_IVENDAS: TStringField
      FieldName = 'TRIBUTACAO_IVENDAS'
      Size = 3
    end
    object cdsI_VendaFISCAL_IVENDAS: TStringField
      FieldName = 'FISCAL_IVENDAS'
      Size = 5
    end
    object cdsI_VendaGARANTIA_IVENDAS: TStringField
      FieldName = 'GARANTIA_IVENDAS'
      Size = 10
    end
    object cdsI_VendaTECNICO_IVENDAS: TIntegerField
      FieldName = 'TECNICO_IVENDAS'
    end
    object cdsI_VendaALTURA_IVENDAS: TFMTBCDField
      FieldName = 'ALTURA_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsI_VendaLARGURA_IVENDAS: TFMTBCDField
      FieldName = 'LARGURA_IVENDAS'
      Precision = 15
      Size = 2
    end
    object cdsI_VendaCOMPRIMENTO_VENDAS: TFMTBCDField
      FieldName = 'COMPRIMENTO_VENDAS'
      Precision = 15
      Size = 2
    end
    object cdsI_VendaQTDE_VENDAS: TIntegerField
      FieldName = 'QTDE_VENDAS'
    end
    object cdsI_VendaCOMPLEMENTO: TStringField
      FieldName = 'COMPLEMENTO'
      Size = 40
    end
    object cdsI_VendaCOD_EMPRESA: TIntegerField
      FieldName = 'COD_EMPRESA'
      Required = True
    end
    object cdsI_VendaCLASSE_IVENDA: TStringField
      FieldName = 'CLASSE_IVENDA'
      Size = 1
    end
    object cdsI_VendaCFOP: TStringField
      FieldName = 'CFOP'
      Size = 5
    end
    object cdsI_VendaSERIE_VENDA: TStringField
      FieldName = 'SERIE_VENDA'
      Size = 2
    end
  end
  object dtsI_Venda: TDataSource
    DataSet = cdsI_Venda
    Left = 248
    Top = 75
  end
  object ppI_Venda: TppDBPipeline
    DataSource = dtsI_Venda
    UserName = 'I_Venda'
    Left = 320
    Top = 72
  end
  object cdsTemp: TClientDataSet
    ...
    Top = 129
    Data = {
      450000009619E0BD010000001800000002000000000003000000450008534954
      554143414F01004900000001000557494454480200020014000556414C4F5208
      000400000000000000}
    object cdsTempSITUACAO: TStringField
      FieldName = 'SITUACAO'
    end
  ...
  object ppTemp: TppDBPipeline
    DataSource = dtsTemp
    UserName = 'Temp'
    Left = 320
    Top = 128
    object ppTempppField1: TppField
      FieldAlias = 'SITUACAO'
      FieldName = 'SITUACAO'
      FieldLength = 20
      DisplayWidth = 20
    ...
    object ppTempppField2: TppField
  ...
  object ppVenda: TppDBPipeline
    ...
    object ppVendappField121: TppField
    ...
    object ppVendappField122: TppField
    ...
    object ppVendappField123: TppField
      FieldAlias = 'TIPO'
      FieldName = 'TIPO'
      FieldLength = 0
      DataType = dtNotKnown
    ...
    object ppVendappField124: TppField
  ...
  object qryCpagamento: TSQLQuery
    MaxBlobSize = -1
    Params = <>
    SQL.Strings = (
      'select c.codigo_cpagamento, c.descricao_cpagamento'
      'from P_CPAGAMENTO c')
    SQLConnection = DmPrincipal.DbConexao
    Left = 32
    Top = 181
    object qryCpagamentoCODIGO_CPAGAMENTO: TIntegerField
      FieldName = 'CODIGO_CPAGAMENTO'
      Required = True
    end
    object qryCpagamentoDESCRICAO_CPAGAMENTO: TStringField
      FieldName = 'DESCRICAO_CPAGAMENTO'
      Size = 40
    end
  end
  object dspCpagamento: TDataSetProvider
    DataSet = qryCpagamento
    Left = 120
    Top = 181
  end
  object cdsCpagamento: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dspCpagamento'
    Left = 208
    Top = 181
    object cdsCpagamentoCODIGO_CPAGAMENTO: TIntegerField
      FieldName = 'CODIGO_CPAGAMENTO'
      Required = True
    end
    object cdsCpagamentoDESCRICAO_CPAGAMENTO: TStringField
      FieldName = 'DESCRICAO_CPAGAMENTO'
      Size = 40
    end
  end
  object dtsCpagamento: TDataSource
    DataSet = cdsCpagamento
    Left = 293
    Top = 180
  end
end
